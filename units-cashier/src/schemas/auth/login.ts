...
export const LoginSchema = object({
    username: string().typeError(userRequiredLabel).required(userRequiredLabel).min(6, 'O usuário deve ter no mínimo 6 dígitos').max(20, 'O usuário deve ter no máximo 20 dígitos'),
